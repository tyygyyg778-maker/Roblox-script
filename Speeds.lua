...
-- Player Tab (Speed, HighJump, Noclip)
...
-- Auto add ESP cho người chơi mới
...
Rayfield:Notify({
   Title = "Vua",
   Content = "Menu Vua loaded successfully",
   Duration = 5
})
